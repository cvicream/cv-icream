...
export default defineConfig({
  shortcuts: [
    ...
    ['icon-24', 'w-6 h-6 text-blacks-40 select-none hover:text-blacks-70'],
    ...
    ['form-textarea', 'w-full h-[130px] bg-white rounded-xl outline-none font-normal text-base text-blacks-100 resize-none disabled:text-blacks-40 placeholder-blacks-40 focus:placeholder-transparent mt-1 px-4 py-3 border-1 border-white transition-all duration-500 hover:border-blacks-100 hover:disabled:border-white focus:text-blacks-100'],
