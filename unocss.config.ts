...
export default defineConfig({
  shortcuts: [
    ...
    ['title-default', 'font-normal text-sm leading-4'],
    ['subtitle-default', 'font-normal text-11 leading-[13px]'],
    ['paragraph-default', 'font-normal text-10 leading-[13px]'],
    ['heading-large', 'font-normal text-4xl leading-[41px]'],
    ['title-large', 'font-normal text-base leading-[19px]'],
    ['subtitle-large', 'font-normal text-sm leading-4'],
    ['paragraph-large', 'font-normal text-xs leading-[14px]'],
