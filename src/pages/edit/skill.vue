  ...
  <div class="flex-grow flex flex-col pr-2 -mr-3 overflow-y-auto custom-scrollbar last-child-pb-4">
      ...
      <div class="flex justify-between items-center">
        ...
        <div
          ...
          :class="{
            ...
            'sm:group-hover:visible': skill.isShow
          }"
        >
          <Tooltip
          ...
          >
            <div class="relative">
              ...
              >
                <button v-if="skill.list.length > 1" class="flex items-center px-4 py-3 sm:hover:bg-primary-10" @click="toggleShowItem(index)">
                  <span
                ...
                <button v-if="skill.list.length > 1" class="flex items-center px-4 py-3 sm:hover:bg-primary-10" @click="showDeleteBlockMessage(index)">
    ...
    >
      <span
        ...
        :class="skill.isShow && 'sm:group-hover:text-blacks-70'"
      />
      <span class="subleading text-ellipsis whitespace-nowrap overflow-hidden" :class="skill.isShow && 'sm:group-hover:text-blacks-100'">
        Add
      </span>
    </button>
  </div>
