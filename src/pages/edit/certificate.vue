  ...
  <div class="flex-grow flex flex-col pr-2 -mr-3 overflow-y-auto custom-scrollbar last-child-pb-4">
    ...
    >
      <div class="flex justify-between items-center">
        ...
        >
          <button v-if="index !== 0 && certificate.list.length > 1" @click="swap(index, index - 1)">
            <span class="i-custom:move-up icon-24" />
          </button>
          <button v-if="(index !== certificate.list.length - 1) && certificate.list.length > 1" @click="swap(index, index + 1)">
