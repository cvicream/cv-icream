...
function addItem() {
  user.$patch((state) => {
    state.contact.list.push(TEMPLATE_LIST_ITEM)
  })
}
      ...
      >
        ...
        <div>
          ...
          <Editor
            ...
            class-name="h-[46px]"
            :enable="item.isShow"
            :placeholder="DEFAULT_TEMPLATE.contact.list[index].title"
            :is-single-line="true"
          />
        </div>
        <div :class="item.isCollapsed ? 'hidden' : 'flex flex-col gap-6'">
          <div>
            ...
            <Editor
              ...
              class-name="h-[46px]"
              :enable="item.isShow"
              :placeholder="DEFAULT_TEMPLATE.contact.list[index].subtitle"
              :is-single-line="true"
            />
          </div>
          <div>
            ...
            <Editor
              ...
              class-name="h-[130px]"
              :enable="item.isShow"
              :placeholder="DEFAULT_TEMPLATE.contact.list[index].paragraph"
            />
          </div>
        </div>
      </div>
