  ...
  <div class="h-full flex flex-col justify-start py-12 px-4 sm:p-4 items-center gap-16">
    ...
    <div class="flex flex-col gap-16 sm:flex-row">
      <div class="flex flex-col justify-between items-center">
        <label for="template-UIDesigner" class="flex flex-col gap-5 cursor-pointer">
      ...
      <div class="flex flex-col justify-between items-center">
        <label for="template-UXDesigner" class="flex flex-col gap-5 cursor-pointer">
      ...
      <div class="flex flex-col justify-between items-center">
        <label for="template-ProductManager" class="flex flex-col gap-5 cursor-pointer">
      ...
      <div class="flex flex-col justify-between items-center">
        <label for="template-BuildFromScratch" class="flex flex-col gap-5 cursor-pointer">
