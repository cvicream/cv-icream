      ...
      list: [
        {
          isShow: true,
          isCollapsed: false,
          title: 'MA Illustration and Book Arts',
          subtitle1: 'Anglia Ruskin University ',
          subtitle2: '',
          paragraph: 'Graduated/ Jan 2021 Cambridge, UK',
        },
      ],
    },
    certificate: {
